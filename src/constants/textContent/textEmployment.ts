...
export const employment_3: Employment = {
  ...
  text: "This position was part of a contract with San Antonio Water System, the largest drinking water and sewage utility in Bexar County. The focus of the contract included the maintenance, feature creation, and CMS conversion of existing websites. Was the primary front end developer for the creation of My Account Customer Portal which is a web application which functions as a billing and payment portal. Routinely used technologies were  This position was on-site in San Antonio, TX.",
  skills: [
    "React",
    "JQuery",
    "Javascript",
