...
export const textHome_4 = `With his expertise in design and development ${ENV_OWNER} is able to shape and guide ideation to shippable products.`;

export const textHome_5 = `Along with his expertise with frontend development ${ENV_OWNER} also has skills in the backend with Python and Flask. ${ENV_OWNER} also holds multiple AWS certifications.`;
